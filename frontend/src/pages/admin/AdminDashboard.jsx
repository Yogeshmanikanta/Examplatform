  ...
  return (
    <div>
      <div style={{ marginBottom: '28px' }}>
        <h1
          style={{ fontSize: '22px', fontWeight: 900, color: '#0f172a', letterSpacing: '-0.5px' }}
        >
      ...
      <div style={S.quickCard}>
        ...
        <div style={S.quickBtns}>
          {[
            ...
            <Link key={a.label} to={a.path} style={S.quickBtn(a.primary)}>
              {a.label}
            </Link>
          ))}
        </div>
