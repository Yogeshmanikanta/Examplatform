  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/exams/exam/:exam_id/live" element={
          <ProtectedRoute allowedRoles={['candidate']}>
            <LiveExamPage />
          </ProtectedRoute>
        } />
        <Route path="/exams/exam/:exam_id/instructions" element={<ProtectedRoute allowedRoles={['candidate']}><ExamInstructionsPage /></ProtectedRoute>} />
        <Route path="/exams/result/:exam_id" element={
          <ProtectedRoute allowedRoles={['candidate']}>
            <ResultPage />
          </ProtectedRoute>
        } />
